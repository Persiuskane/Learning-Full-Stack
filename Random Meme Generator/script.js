...
const riddles = [
  ...
  {
    riddle:
      "What English word is both a noun and a verb, yet if you spell it backwards it becomes an adjective?",
    answer: "Evil (live spelled backwards means lively/alive)",
  },
  {
    riddle:
      "I am an odd number and if you take away one letter from me, I become even. What am I?",
    answer: "Seven (remove the 's')",
  },
  {
    riddle:
      "I am invisible, can travel at the speed of light, and can bend around objects. What am I?",
    answer: "Light",
  },
  {
    riddle:
      "What can break, but never falls, and what can fall, but never breaks?",
  ...
  {
    riddle:
      "I am not made of atoms, yet I have a mass. I have no form, but I take up space. I am infinite yet can fit in your hand. What am I?",
    answer: "Infinity/knowledge/time (conceptual answer)",
  },
  {
    riddle:
      "I contain cities, but not houses. I contain forests, but not trees. I contain water, but not fish. What am I?",
    answer: "A globe",
  },
  {
    riddle:
